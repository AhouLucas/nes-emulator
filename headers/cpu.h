...
void CPU_ALR(CPU_t*, AddressingMode_t);
void CPU_AND(CPU_t*, AddressingMode_t);
void CPU_ANC(CPU_t*, AddressingMode_t);
void CPU_ARR(CPU_t*, AddressingMode_t);
uint8_t CPU_ASL(CPU_t*, AddressingMode_t);
void CPU_ASL_ACC(CPU_t*, AddressingMode_t);
void CPU_AXS(CPU_t*, AddressingMode_t);
...
void CPU_DCP(CPU_t*, AddressingMode_t);
...
void CPU_LXA(CPU_t*, AddressingMode_t);
...
void CPU_SAX(CPU_t*, AddressingMode_t);
...
void CPU_SKB(CPU_t*, AddressingMode_t);
